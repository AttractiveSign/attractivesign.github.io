...
**Live Demo:** [attractivesign.github.io](https://attractivesign.github.io)
...
* **CSS3:** Custom styling with a focus on responsive design and modern layouts (Flexbox/Grid).
...
* `index.html`: The main "one-pager" including my Bio, Tech Stack, and Project Overview.
* `style.css`: Centralized stylesheet using CSS Variables for easy theming.
* `project-*.html`: Detailed pages for individual projects (e.g., Home Server, Linux setup).
...
- **Tech-Oriented Design:** Minimalist "Dark Mode" aesthetic, reflecting my passion for Linux and server environments.

---

> *This site is continuously evolving as I learn new technologies. Feel free to explore the code!*
